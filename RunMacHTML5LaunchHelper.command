...
EPIC_MONO=""
if [ -f "Q:\UE_4.21\Engine\Build\BatchFiles\Mac\SetupMono.sh" ]; then
    pushd "Q:\UE_4.21\Engine\Build\BatchFiles\Mac"
	source SetupMono.sh
    popd
else
	EPIC_MONO="NOTE: It seems this $0 was built from another platform and copied here.\nNOTE: Was expecting to setup mono via: "'Q:\UE_4.21\Engine\Build\BatchFiles\Mac\SetupMono.sh';
fi
